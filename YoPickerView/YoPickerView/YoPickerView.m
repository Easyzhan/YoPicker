...
@interface YoPickerView()<UIPickerViewDelegate, UIPickerViewDataSource>
...
@property (nonatomic, assign) YoPickerViewType pickerType;

@end

@implementation YoPickerView
...
{
    YoPickerView *view = [[YoPickerView alloc] initWithMaxValue:maxValue
...
+ (void)showNumericalPickerViewWithValues:(NSMutableArray *)values
                          completionBlock:(void (^)(int selectedValue))completionBlock
{
    YoPickerView *view = [[YoPickerView alloc] initWithValues:values
                                               withPickerView:YoNumbersPickerView];
    view.completionNumberBlock = completionBlock;
...
{
    YoPickerView *view = [[YoPickerView alloc] initWithValues:values
                                               withPickerView:YoTextPickerView];
...
- (id)initWithValues:(NSMutableArray *)values withPickerView:(YoPickerViewType)pickerType;
{
...
- (id)initWithFrame:(CGRect)frame withValues:(NSMutableArray *)values withPickerView:(YoPickerViewType)pickerType;
{
...
- (id)initWithFrame:(CGRect)frame withMaxValue:(int)maxValue withMinValue:(int)minValue
{
    ...
    if (self) {
        ...
        self.pickerType = YoNumbersPickerView;
...
- (void)dismissPicker
{
    if (self.pickerType == YoNumbersPickerView) {
...
- (NSString *)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component
{
    ...
    if (self.valuesArray) {
        ...
        if (self.pickerType == YoTextPickerView) return [self.valuesArray objectAtIndex:row];
